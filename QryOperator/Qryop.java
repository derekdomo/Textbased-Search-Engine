package QryOperator; /**
 *  All query operators are subclasses of the QryOperator.Qryop class.  Most of
...
public abstract class Qryop {
  ...
  //  query evaluation
  // each instance represent a term vector that will be operated
  protected class DaaTPtr {
    ...
    protected int nextDoc;		// The next document to examine, it has nothing to do with the doc id
  };
  ...
  /**
   * Return the invertedlist of the nth DaatPtr
   * @param n the nth daatptr
   * @return invertedlist
   * */
  public InvList getInvertedList(int n) {
      return daatPtrs.get(0).invList;
  }
